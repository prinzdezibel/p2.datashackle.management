...
// Mary is Peter's child 
 Change this //a[0].child=a[1];
 
// Which logically means Peter is Mary's parent
 Change this //a[1].parent=a[0];
 

// Flags that affects the stringifier
// (default:false,false,false,true,true)
 Change this JSONstring.compactOutput=false;     
 Change this JSONstring.includeProtos=false;     
 Change this JSONstring.includeFunctions=false;     
 Change this JSONstring.detectCirculars=true;          
 Change this JSONstring.restoreCirculars=true;
 
// Now let us stringify this
var s=JSONstring.make(a);
 
/*---------------------- s will now have to following value: ---------------------- 
[{"name":"Peter",
"age":40,
"child":{"name":"Mary",
"age":20,
"parent":"JSONcircRef:0"}},
"JSONcircRef:0.child"]
----------------------------------------------------------------------------------------*/
...
// 
/*------------------- bTest will now have to following value: ------------------- 
[object Object], Mary, Peter
----------------------------------------------------------------------------------------*/
