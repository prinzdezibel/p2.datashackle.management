(function($) {
        jQuery.fn.html5_upload = function(options) {
                ...
                var options = jQuery.extend({
                        ...
                        sendBoundary: false,
                        fieldName: 'file',//ignore if sendBoundary is false
                        method: 'post',
                ...
                function upload() {
                        ...
                        function upload_file(number) {
                                ...
                                if (!$this.triggerHandler('html5_upload.onStartOne', [xhr, file.fileName, number, total])) {
                                        return upload_file(number+1);
                                }
                                xhr.setRequestHeader("Cache-Control", "no-cache");
                                xhr.setRequestHeader("X-Requested-With", "XMLHttpRequest");
                                xhr.setRequestHeader("X-File-Name", file.fileName ? file.fileName : file.name);
                                xhr.setRequestHeader("X-File-Size", file.fileSize ? file.fileSize : file.size);
                ...
                return this.each(function() {
                        ...
                        // set ready state
                        options.setStatus(options.genStatus(-1));
                });
        };
})(jQuery);
